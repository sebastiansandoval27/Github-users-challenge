...
const UserItem: React.FC<Props> = ({ user: { id, login }, onClick, disabled = false }) => {
  return (
    <div
      className={`
    w-full h-12 flex items-center justify-start px-4 py-3 my-2 bg-teal-500 rounded-md cursor-pointer hover:bg-cyan-950 hover:transition-all hover:duration-500
